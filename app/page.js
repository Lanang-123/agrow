    ...
    <>
      ...
      <div class="w-full md:py-12 md:px-32 p-4 bg-white">
        ...
        <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div class="md:max-w-xs w-full overflow-hidden bg-white rounded-lg shadow-xl shadow-teal-100 dark:bg-gray-800">
            <div class="px-4 py-2">
              <h1 class="text-xl font-bold text-teal-900 uppercase ">NIKE AIR</h1>
              <p class="mt-1 text-sm text-gray-400 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi quos quidem sequi illum facere recusandae voluptatibus</p>
            </div>

            <Image class="object-cover w-full h-48 mt-2" src={Dagang} alt="NIKE AIR" />

            <div class="flex items-center justify-between px-4 py-2 bg-teal-500">
              <h1 class="text-lg font-bold text-white">Rp 10.000.000</h1>
      ...
      <div class="w-full md:py-12 md:px-32 p-4 bg-white">
        ...
        <div class="grid grid-cols-1 gap-12 md:grid-cols-2 xl:grid-cols-3">
          <div class="overflow-hidden rounded-lg shadow-lg h-90 w-full md:w-full ">
            <div class="block w-full h-full">
              <Image alt="blog photo" src={Dagang} class="object-cover w-full max-h-40" />
              <div class="w-full p-4 bg-white dark:bg-gray-800 group-hover:bg-teal-500">
                <p class="font-medium text-teal-500 text-md group-hover:text-white">
                  Pengetahuan
                </p>
                <p class="mb-2 text-xl font-medium text-gray-800 dark:text-white group-hover:text-white">
                  Edukasi Tanaman Segar
                </p>
                <p class="font-light text-gray-400 dark:text-gray-300 text-md group-hover:text-white">
                  Work at home, remote, is the new age of the job, every person can work at home....
                </p>
                <Link href="/" className="group cursor-pointer">
                  <div class="flex items-center justify-center mt-4 border-2 border-teal-500 p-1 rounded-lg group-hover:bg-teal-500">
